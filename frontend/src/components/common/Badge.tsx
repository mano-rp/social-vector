...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variantClasses = {
    ...
    info: 'bg-blue-50 text-blue-700 dark:bg-cyan-950/40 dark:text-cyan-400 border-blue-200 dark:border-cyan-800/50',
    blue: 'bg-blue-50 text-blue-700 dark:bg-cyan-950/40 dark:text-cyan-400 border-blue-200 dark:border-cyan-800/50',
    cyan: 'bg-cyan-50 text-cyan-700 dark:bg-cyan-950/40 dark:text-cyan-400 border-cyan-200 dark:border-cyan-800/50',
  }[variant] || 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border-slate-200 dark:border-slate-700';
