...
export const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <article className="p-4 sm:p-5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f141c] hover:border-slate-300 dark:hover:border-slate-700 transition-colors">
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="flex items-center gap-2">
          {post.client_source && (
            <span className="hidden sm:inline-block text-[10px] font-mono text-slate-400 dark:text-slate-500 px-1.5 py-0.5 rounded bg-slate-50 dark:bg-slate-900/80 border border-slate-100 dark:border-slate-800">
              {post.client_source}
            </span>
          )}
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 text-[11px] font-medium text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-cyan-400 bg-slate-50 dark:bg-slate-800/80 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded transition-colors"
          >
            <Activity className="w-3 h-3 text-slate-400 dark:text-cyan-400" />
            <span className="hidden sm:inline">Analyse Feed</span>
          </button>
        </div>
      </div>
      ...
      <div className="pl-0 sm:pl-13">
        ...
        {post.entities.urls.length > 0 && (
          <div className="my-3 p-2.5 rounded-md bg-slate-50 dark:bg-[#161d28] border border-slate-100 dark:border-slate-800/80 flex flex-col gap-1.5">
                ...
                <div key={i} className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-1.5 truncate">
                    ...
                    <span
                      ...
                      className="font-mono text-slate-600 dark:text-slate-300 hover:underline cursor-pointer truncate"
                    >
                      {domain}
                    </span>
                  </div>
        ...
        <div className="flex items-center gap-5 sm:gap-8 pt-3 mt-2 border-t border-slate-100 dark:border-slate-800/60 text-slate-400 dark:text-slate-500 text-xs font-mono">
